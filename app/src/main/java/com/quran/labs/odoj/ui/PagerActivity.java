package com.quran.labs.odoj.ui;
...
import com.quran.labs.odoj.HelpActivity;
...
import com.quran.labs.odoj.SearchActivity;
import com.quran.labs.odoj.common.LocalTranslation;
import com.quran.labs.odoj.common.QariItem;
import com.quran.labs.odoj.common.QuranAyah;
import com.quran.labs.odoj.component.activity.PagerActivityComponent;
import com.quran.labs.odoj.data.AyahInfoDatabaseProvider;
import com.quran.labs.odoj.data.Constants;
import com.quran.labs.odoj.data.QuranData;
...
import com.quran.labs.odoj.database.TranslationsDBAdapter;
import com.quran.labs.odoj.model.bookmark.BookmarkModel;
import com.quran.labs.odoj.model.translation.ArabicDatabaseUtils;
import com.quran.labs.odoj.module.activity.PagerActivityModule;
import com.quran.labs.odoj.presenter.bookmark.RecentPagePresenter;
import com.quran.labs.odoj.service.AudioService;
import com.quran.labs.odoj.service.QuranDownloadService;
import com.quran.labs.odoj.service.util.AudioRequest;
import com.quran.labs.odoj.service.util.DefaultDownloadReceiver;
import com.quran.labs.odoj.service.util.DownloadAudioRequest;
import com.quran.labs.odoj.service.util.QuranDownloadNotifier;
import com.quran.labs.odoj.service.util.ServiceIntentHelper;
import com.quran.labs.odoj.service.util.StreamingAudioRequest;
import com.quran.labs.odoj.ui.fragment.AddTagDialog;
import com.quran.labs.odoj.ui.fragment.AyahActionFragment;
import com.quran.labs.odoj.ui.fragment.JumpFragment;
...
import com.quran.labs.odoj.ui.helpers.QuranDisplayHelper;
import com.quran.labs.odoj.ui.helpers.QuranPage;
import com.quran.labs.odoj.ui.helpers.QuranPageAdapter;
import com.quran.labs.odoj.ui.helpers.QuranPageWorker;
import com.quran.labs.odoj.ui.helpers.SlidingPagerAdapter;
import com.quran.labs.odoj.ui.util.TranslationsSpinnerAdapter;
import com.quran.labs.odoj.util.AudioUtils;
import com.quran.labs.odoj.util.QuranAppUtils;
import com.quran.labs.odoj.util.QuranFileUtils;
import com.quran.labs.odoj.util.QuranScreenInfo;
import com.quran.labs.odoj.util.QuranSettings;
import com.quran.labs.odoj.util.QuranUtils;
import com.quran.labs.odoj.util.ShareUtil;
import com.quran.labs.odoj.util.StorageUtils;
import com.quran.labs.odoj.util.TranslationUtils;
import com.quran.labs.odoj.widgets.AudioStatusBar;
import com.quran.labs.odoj.widgets.AyahToolBar;
import com.quran.labs.odoj.widgets.IconPageIndicator;
import com.quran.labs.odoj.widgets.QuranSpinner;
import com.quran.labs.odoj.widgets.SlidingUpPanelLayout;
...
import static com.quran.labs.odoj.data.Constants.PAGES_LAST;
import static com.quran.labs.odoj.data.Constants.PAGES_LAST_DUAL;
import static com.quran.labs.odoj.ui.helpers.SlidingPagerAdapter.AUDIO_PAGE;
import static com.quran.labs.odoj.ui.helpers.SlidingPagerAdapter.PAGES;
import static com.quran.labs.odoj.ui.helpers.SlidingPagerAdapter.TAG_PAGE;
import static com.quran.labs.odoj.ui.helpers.SlidingPagerAdapter.TRANSLATION_PAGE;
import static com.quran.labs.odoj.widgets.AyahToolBar.AyahToolBarPosition;
...
public class PagerActivity extends QuranActionBarActivity implements
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    viewPager.addOnPageChangeListener(new OnPageChangeListener() {
      ...
      public void onPageSelected(int position) {
        ...
        juz = QuranInfo.getJuzFromPage(page);
        int lastPageOfCurrentJuz = (juz == QuranData.JUZ_PAGE_START.length) ? QuranData.LAST_PAGE : QuranData.JUZ_PAGE_START[juz] - 1;
        //TODO: ADD LAPOR BUTTON
        showLaporMenu = false;
        if (page == lastPageOfCurrentJuz) {
          showLaporMenu = true;
          Toast.makeText(getApplicationContext(), String.format(getString(R.string.lastJuzToast), juz), Toast.LENGTH_SHORT).show();
        }
  ...
  public boolean onCreateOptionsMenu(Menu menu) {
    ...
    (menu.findItem(R.id.laporhwatsapp)).setVisible(showLaporMenu);
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    ...
    if (itemId == R.id.favorite_item) {
      ...
      return true;
    } else if (itemId == R.id.laporhwatsapp) {
      Intent sendIntent = new Intent();
      sendIntent.setAction(Intent.ACTION_SEND);
      SharedPreferences pref = StorageUtils.getPref(getApplicationContext());
      Date date = new Date();
      SimpleDateFormat dateFormat = new SimpleDateFormat("HH:mm:ss");
      String nama = pref.getString(getString(R.string.ODOJ_RECITER_NAME), "Nama Anda");
      String lapor = String.format("ODOJ lapor %s juz %02d, %s", nama, juz, dateFormat.format(date));
      sendIntent.putExtra(Intent.EXTRA_TEXT, lapor);
      sendIntent.setType("text/plain");
      startActivity(sendIntent);
    } else if (itemId == R.id.namapembaca) {
      AlertDialog.Builder dialog = new AlertDialog.Builder(this);
      dialog.setTitle(getString(R.string.titleReciterName));
      SharedPreferences pref = StorageUtils.getPref(getApplicationContext());
      String nama = pref.getString(getString(R.string.ODOJ_RECITER_NAME), "");
      View reciterEditor = getLayoutInflater().inflate(R.layout.edit_reciter_name, null);
      dialog.setView(reciterEditor);
      EditText etReciter = (EditText) reciterEditor.findViewById(R.id.reciterName);
      if (nama.trim().length() > 1) {
        etReciter.setHint(nama);
      }
      ...
      dialog.setNeutralButton(getString(R.string.cancelReciterNameSetting), null);
      dialog.show();
    }
